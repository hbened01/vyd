...
class TabListRubrosPptosController extends Controller
{
	/**
	...
	{
		$model=new TabListRubrosPptos;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['TabListRubrosPptos']))
		{
			$model->attributes=$_POST['TabListRubrosPptos'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_list_rubros_pptos));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('TabListRubrosPptos');
	...
	*/
	...
	public function actionIndex()
	{
		$model=new TabListRubrosPptos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TabListRubrosPptos']))
			$model->attributes=$_GET['TabListRubrosPptos'];
	 ...
	 * @return TabListRubrosPptos the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TabListRubrosPptos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TabListRubrosPptos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tab-list-rubros-pptos-form')
		{
    ...
    $model=TabListRubrosPptos::model()->findAll();
    ...
    $this->toExcel($model,
        array(
        	...
        	'LISTADO_RUBROS_PRESUPUESTADOS_COMPLETO',
        array(
            'creator' => 'SWL',
        ),
