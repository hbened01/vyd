...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'co_org_dpnd'); ?>
		<?php echo $form->textField($model,'co_org_dpnd'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'nb_org'); ?>
		<?php echo $form->textField($model,'nb_org',array('size'=>60,'maxlength'=>128)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'tx_descripcion'); ?>
		<?php echo $form->textField($model,'tx_descripcion',array('size'=>60,'maxlength'=>250)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'abv_org'); ?>
		<?php echo $form->textField($model,'abv_org',array('size'=>6,'maxlength'=>6)); ?>
	</div>
