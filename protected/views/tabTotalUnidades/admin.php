<?php $this->setPageTitle('total ing. unidades'); ?>
<?php
...
$('.search-form form').submit(function(){
	$('#tab-total-unidades-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
?>
<br>
<h1>Ingresos totales por unidades</h1>
<br>
<p>
...
<?php
    ...
    'gridViewId' => 'tab-total-unidades-grid',
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        ...
        'filter' => CHtml::listData(TabTotalUnidades::model()->findAll(array("select"=>"anio", "distinct"=>"true", "order"=>"anio")), 'anio','anio') 
                ),
		//'id_mes',
		array(
        'header'=>'Mes',
        ...
        'htmlOptions'=>array('style'=>'text-align: center','width'=>'80px'),
        'filter' => CHtml::listData(TabUnidadFuncional::model()->findAll(array("order"=>"descrip_unidad_funcional")), 'id_unidad_funcional','descrip_unidad_funcional')
                ),
        //'id_tipo_ingreso',
		array(
        'header'=>'Tipo ingreso',
...
<div class="column">
    ...
    <?php echo CHtml::submitButton('Generar excel filtrado', array('submit'=>array('TabTotalUnidades/rubroExportToExcel_1'),)); ?>

</div>

<div class="column">
    
    <?php echo CHtml::submitButton('Generar excel completo', array('submit'=>array('TabTotalUnidades/rubroExportToExcel_2'),)); ?>
