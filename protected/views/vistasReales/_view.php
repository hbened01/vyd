...
<div class="view">
    ...
    'fecha'=>$data->fecha, 'rubro'=>$data->rubro, 'entidad_legal'=>$data->entidad_legal, 'segmento'=>$data->segmento, 'monto'=>$data->monto)); ?><br/></b>
    ...
    <?php echo CHtml::encode($data->id_rubro); ?><br />
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('id_voz_datos_reales')); ?>:</b>
    <?php echo CHtml::encode($data->id_voz_datos_reales); ?><br />
