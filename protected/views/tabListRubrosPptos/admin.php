...
<?php $this->setPageTitle('listado de ins. pptos'); ?>
<?php
...
$('.search-form form').submit(function(){
    $('#tab-list-rubros-pptos-grid').yiiGridView('update', {
        data: $(this).serialize()
    });
    return false;
});
...
<?php
    ...
    'gridViewId' => 'tab-list-rubros-pptos-grid',
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
        ...
        'value' => '$data->nb_rubro',
        'htmlOptions'=>array('style'=>'text-align: center','width'=>'80px'),
        'filter' => CHtml::listData(TabListRubrosPptos::model()->findAll(array("order"=>"nb_rubro")), 'nb_rubro','nb_rubro')
                ),
        //'nb_unidad_funcional',
        array(
        ...
        'htmlOptions'=>array('style'=>'text-align: center','width'=>'80px'),
        'filter' => CHtml::listData(TabListRubrosPptos::model()->findAll(), 'nb_unidad_funcional','nb_unidad_funcional')
                ),
        //'estado',
        array(
        'header'=>'Estado',
        ...
        'value' => '$data->estado',
        'htmlOptions'=>array('style'=>'text-align: center','width'=>'80px'),
        'filter' => CHtml::listData(TabListRubrosPptos::model()->findAll(), 'estado','estado')
                ),
        'signo',
        /*
        'in_stat',
