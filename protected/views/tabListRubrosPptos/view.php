...
$this->menu=array(
	...
	*/
	array('label'=>'Actualizar registro', 'url'=>array('update', 'id'=>$model->id_list_rubros_pptos)),
	/*
	array('label'=>'Eliminar registro', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id_list_rubros_pptos),'confirm'=>'¿Está seguro que desea eliminar este registro?')),
	*/
