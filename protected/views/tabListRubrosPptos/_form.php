...
<?php $form=$this->beginWidget('CActiveForm', array(
 ...
 son obligatorios.</p>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'id_entidad_legal', CHtml::listData(VistasPpto::model()->findAllBySql("SELECT DISTINCT a.id_entidad_legal, a.descrip_entidad_legal AS entidad_legal
