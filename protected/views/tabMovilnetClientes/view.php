...
$this->menu=array(
	...
	array('label'=>'Actualizar registro', 'url'=>array('update', 'id'=>$model->id_mov_cli)),
	array('label'=>'Eliminar registro', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id_mov_cli),'confirm'=>'¿Está seguro que desea eliminar este registro?')),
	*/
