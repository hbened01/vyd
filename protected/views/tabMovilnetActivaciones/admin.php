<?php $this->setPageTitle('movilnet activaciones'); ?>
<?php
...
$('.search-form form').submit(function(){
	$('#tab-movilnet-activaciones-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php
    ...
    'gridViewId' => 'tab-movilnet-activaciones-grid',
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'tab-movilnet-activaciones-grid',
	...
	'columns'=>array(
        ...
        'filter' => CHtml::listData(TabMovilnetActivaciones::model()->findAll(array("select"=>"anio", "distinct"=>"true", "order"=>"anio")), 'anio','anio') 
                ),
		//'mes',
		array(
        'header'=>'Mes',
        ...
        'htmlOptions'=>array('style'=>'text-align: center','width'=>'80px'),
        'filter' => CHtml::listData(TabMovilnetActivaciones::model()->findAll(array("select"=>"tipo_cliente", "distinct"=>"true", "order"=>"tipo_cliente")), 'tipo_cliente','tipo_cliente') 
                ),
		//'tipo_cuenta',
		array(
        ...
        'htmlOptions'=>array('style'=>'text-align: center','width'=>'80px'),
        'filter' => CHtml::listData(TabMovilnetActivaciones::model()->findAll(array("select"=>"tipo_cuenta", "distinct"=>"true", "order"=>"tipo_cuenta")), 'tipo_cuenta','tipo_cuenta') 
                ),
		//'plan',
		array(
        'header'=>'Plan',
        ...
        'value' => '$data->plan',
        'htmlOptions'=>array('style'=>'text-align: center','width'=>'80px'),
        'filter' => CHtml::listData(TabMovilnetActivaciones::model()->findAll(array("select"=>"plan", "distinct"=>"true", "order"=>"plan")), 'plan','plan') 
                ),
		'cantidad',
		/*
		'id_mov_act',
...
<div class="column">
    ...
    <?php echo CHtml::submitButton('Generar excel filtrado', array('submit'=>array('TabMovilnetActivaciones/rubroExportToExcel_1'),)); ?>

</div>

<div class="column">
    
    <?php echo CHtml::submitButton('Generar excel completo', array('submit'=>array('TabMovilnetActivaciones/rubroExportToExcel_2'),)); ?>
