...
/* @var $data TabMovilnetActivaciones */
?>
...
<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('id_mov_act')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_mov_act), array('view', 'id'=>$data->id_mov_act)); ?>
	<br />
