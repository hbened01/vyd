    <?php $this->setPageTitle('gráficas ins. corporación'); ?>

    <?php if ($_POST['anio']==null || empty($_POST['descrip_total']) || empty($_POST['descrip_categoria'])){
            $this->redirect(array('TabTotalCorporacion/select'));
    }?>
    ...
    ?>
    <!-- Condiciones para mostrar mensaje de cateoria asociada -->
...
<script type="text/javascript">
            ...
            document.write('Gráfica de totales de la corporación.');
        
            var chartData =  <?php echo TabTotalCorporacion::model()->Parametro1();?>
                ...
                menuItemOutput:{
                fileName:"Gráfica de totales de la corporación"
                },
                menuItemStyle: {
    ...
    <div id="col&lin" style="width:750px; height:350px;"></div>
    </div>
    ...
    <?php
    $Json = TabTotalCorporacion::model()->Parametro1();
...
muestra_oculta('chartdiv');
            ...
            var chartData2 = <?php echo TabTotalCorporacion::model()->Parametro2();?>
 ...
 <!--<div id="chartdiv"></div> -->
    ...
    <?php
    $Json = TabTotalCorporacion::model()->Parametro2();
    $Json = json_decode($Json,true);
    ?>
          <hr>
          <hr>
