...
<div class="view">
	...
	<?php /*
    <b><?php echo CHtml::encode($data->getAttributeLabel('id_tot_corp')); ?>:</b>
    <?php echo CHtml::link(CHtml::encode($data->id_tot_corp), array('view', 'id'=>$data->id_tot_corp)); ?>
    <br />
