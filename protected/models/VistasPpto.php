...
/**
 * This is the model class for table "vistas_ppto".
 *
 * The followings are the available columns in table 'vistas_ppto':
 ...
 * @property string $id_voz_datos_ppto
 ...
 */
class VistasPpto extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('anio, rubro, entidad_legal, unidad_negocio, segmento, monto, id_mes', 'required'),
            ...
            array('entidad_legal, unidad_negocio, segmento', 'length', 'max'=>50),
            ...
            array('fecha, anio, rubro, entidad_legal, unidad_negocio, segmento, monto, id_mes, id_moneda, id_tipo_ingreso, id_rubro, id_categoria, id_unidad_funcional, id_voz_datos_ppto, signo, in_stat, usr_crea, fe_crea, usr_modf, fe_modf', 'safe', 'on'=>'search'),
        );
    }
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_voz_datos_ppto' => 'Id. Voz datos ppto',
			'signo' => 'Signo',
	...
	public function search()
	{
		...
		$criteria->compare('id_voz_datos_ppto',$this->id_voz_datos_ppto,true);
	...
	*/
	...
	public function search()
	{
		...
		$ppto_data = new CActiveDataProvider(get_class($this), array(
			'criteria'=>$criteria,
		));

		$_SESSION['ppto_records'] = $ppto_data;
        return $ppto_data;
	}
	 ...
	 * @return VistasPpto the static model class
	 */
