...
/**
 * This is the model class for table "tab_list_rubros_reales".
 *
 * The followings are the available columns in table 'tab_list_rubros_reales':
 * @property string $id_list_rubros_reales
 ...
 */
class TabListRubrosReales extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id_list_rubros_reales, id_rubro, id_categoria, id_unidad_funcional, id_entidad_legal, nb_rubro, nb_unidad_funcional, estado, signo, in_stat, usr_crea, fe_crea, usr_modf, fe_modf', 'safe', 'on'=>'search'),
        );
    }
	...
	{
		return array(
			'id_list_rubros_reales' => 'Identificador',
			'id_rubro' => 'Id. Rubro',
	...
	public function search()
	{
		...
		$criteria->compare('id_list_rubros_reales',$this->id_list_rubros_reales,true);
	 ...
	 * @return TabListRubrosReales the static model class
	 */
