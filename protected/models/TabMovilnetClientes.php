...
/**
 * This is the model class for table "tab_movilnet_clientes".
 *
 * The followings are the available columns in table 'tab_movilnet_clientes':
 * @property string $id_mov_cli
 ...
 */
class TabMovilnetClientes extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_mov_cli, fecha, anio, mes, tipo_cliente, tipo_cuenta, plan, cantidad, in_stat, usr_crea, fe_crea, usr_modf, fe_modf', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_mov_cli',$this->id_mov_cli,true);
	...
	*/
	...
	public function search()
	{
		...
		$clientes_data = new CActiveDataProvider(get_class($this), array(
			'criteria'=>$criteria,
		));

		$_SESSION['clientes_records'] = $clientes_data;
	 ...
	 * @return TabMovilnetClientes the static model class
	 */
