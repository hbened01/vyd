 ...
 * @property CnxEmpleados[] $cnxEmpleadoses
 * @property CrugeAuthitem[] $crugeAuthitems
 * @property CrugeFieldvalue[] $crugeFieldvalues
 */
class TablaCrugeUser extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'cnxEmpleadoses' => array(self::HAS_MANY, 'Empleados', 'username'),
	 ...
	 * @return TablaCrugeUser the static model class
	 */
