 ...
 */
class CrugeFactoryLdap
{

    public static function get()
    {
        return CrugeUtilLdap::factory();
    }
    ...
    */
    ...
    {
        foreach (CrugeUtilLdap::config()->availableAuthMethods as $key => $val) {
            return $val;
        }
        return false;
    }
    ...
    */
    public function getUserFilter()
    {
        ...
        $filterClass = CrugeUtilLdap::config()->userFilter;

        $filepath = Yii::getPathOfAlias($filterClass) . ".php";
        $className = CrugeUtilLdap::getClassNameFromPhp($filepath);
    ...
    {
        return CrugeStoredUserLdap::loadModel($username, 'username');
    }
}
